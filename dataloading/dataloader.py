# from https://deepfakes1m.github.io/2025
import os
...
# A torch.utils.data.Dataset for handling video and audio data.
...
# A LightningDataModule for managing datasets and data loaders.
...
# An IterableDataset for handling individual video frames.
...
# A Dataset for handling entire videos.
...
# A Dataset for handling audio data
...
# A Dataset for handling video segments.
...
# Similar to AVDeepfake1mImages, but tailored for the AV-Deepfake1M++ dataset.
